...
export const products = [
    {
        ...
        descriptions: "Iphone 15 Pro hadir dengan chip A17 Pro yang revolusioner, bodi titanium ringan, dan sistem kamera Pro terbaik yang pernah ada di Iphone.",
        specs: {
...
export const getBestSellers = () => products.filter((p) => p.badges?.includes("best-seller"));

export const getNewArrivals = () => products.filter((p) => p.badges?.includes("new"));
